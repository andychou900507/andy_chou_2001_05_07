...
// 位置改變
        ...
        if (direction == 0 && head_row >= 3 && head_row <= 11) { // 往上
            head_row = head_row - 1;
        } else if (direction == 1 && head_row >= 2 && head_row <= 10) { // 往下
            head_row = head_row + 1;
...
// 不斷顯示位置
        for (var a = 0; a <= 12; a++) {
            for (var b = 0; b <= 12; b++) {
                ...
                else if (map[a][b] == 0) content_1.innerHTML = content_1.innerHTML + "&nbsp&nbsp&nbsp";
                else if (map[a][b] == 3) content_1.innerHTML = content_1.innerHTML + "&nbsp*&nbsp";
                else if (map[a][b] == 2) content_1.innerHTML = content_1.innerHTML + "&nbspx&nbsp";
                else content_1.innerHTML = content_1.innerHTML + "&nbspx&nbsp"
            }
...
for (var a = 0; a <= 12; a++) {
    for (var b = 0; b <= 12; b++) {
        ...
        else content_1.innerHTML = content_1.innerHTML + "&nbsp*&nbsp";
    }
    content_1.innerHTML = content_1.innerHTML + "<BR>"
}
